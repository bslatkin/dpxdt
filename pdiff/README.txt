...
5. Type cmake -DCMAKE_TOOLCHAIN_FILE=../toolchain_linux.cmake .. (or whatever toolchain you need)
6. Type make .
7. To do make clean, rm -Rf the build directory and start at #3 again.
